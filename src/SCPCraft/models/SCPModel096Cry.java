...
/* 56 */     this.leftleg.a(2.0F, 9.0F, 1.0F);
...
/* 62 */     this.neck.a(0.0F, -3.0F, 1.0F);
/* 63 */     this.neck.b(64, 32);
/* 64 */     this.neck.i = true;
/* 65 */     setRotation(this.neck, 0.0F, 0.0F, 0.0F);
/* 66 */     this.mouth = new ayf(this, 15, 14);
/* 67 */     this.mouth.a(-3.0F, -2.0F, -4.0F, 6, 3, 2);
/* 68 */     this.mouth.a(0.0F, -3.0F, 1.0F);
/* 69 */     this.mouth.b(64, 32);
/* 70 */     this.mouth.i = true;
/* 71 */     setRotation(this.mouth, 0.2792527F, 0.0F, 0.0F);
/*    */   }
/*    */ 
/*    */   
...
/* Location:              /home/luigi/Documents/JAR.jar!/SCPCraft/models/SCPModel096Cry.class
