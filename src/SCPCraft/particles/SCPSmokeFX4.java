...
/*    */ import yc;
/*    */ 
/*    */ public class SCPSmokeFX4
/*    */   extends azq {
/*    */   float smokeParticleScale;
/*    */   public int getMetadata;
/*    */   
/*    */   public SCPSmokeFX4(yc par1World, double par2, double par4, double par6, double par8, double par10, double par12) {
/* 19 */     this(par1World, par2, par4, par6, par8, par10, par12, 1.0F);
/*    */   }
/*    */ 
/*    */   
/*    */   public SCPSmokeFX4(yc par1World, double par2, double par4, double par6, double par8, double par10, double par12, float par14) {
...
/*    */     }
/*    */     
/* 81 */     i(7 - this.d * 8 / this.e);
/* 82 */     this.y += 0.004D;
/* 83 */     d(this.w, this.x, this.y);
/*    */     
/* 85 */     if (this.u == this.r) {
/*    */       
/* 87 */       this.w *= 1.1D;
...
/*    */     } 
/*    */     
/* 91 */     this.w *= 0.9599999785423279D;
/* 92 */     this.x *= 0.9599999785423279D;
/* 93 */     this.y *= 0.9599999785423279D;
/*    */   }
/*    */ }


/* Location:              /home/luigi/Documents/JAR.jar!/SCPCraft/particles/SCPSmokeFX4.class
