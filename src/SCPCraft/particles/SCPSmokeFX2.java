...
/*    */ import yc;
/*    */ 
/*    */ public class SCPSmokeFX2
/*    */   extends azq {
/*    */   float smokeParticleScale;
/*    */   public int getMetadata;
/*    */   
/*    */   public SCPSmokeFX2(yc par1World, double par2, double par4, double par6, double par8, double par10, double par12) {
/* 19 */     this(par1World, par2, par4, par6, par8, par10, par12, 1.0F);
/*    */   }
/*    */ 
/*    */   
/*    */   public SCPSmokeFX2(yc par1World, double par2, double par4, double par6, double par8, double par10, double par12, float par14) {
...
/*    */   
/*    */   public void j_() {
/* 62 */     qx player = this.p.b((lq)this, 16.0D);
/* 63 */     if (player != null) {
/* 64 */       ur var9 = player.bJ.f(3);
/* 65 */       if (var9 != null)
/* 66 */       { if (var9.c != mod_SCP.GasMask.cj && d((lq)player) < 1.0D) {
/* 67 */           player.d(new lm(ll.q.H, 140, 1));
/*    */         } }
/* 69 */       else if (d((lq)player) < 1.0D) { player.d(new lm(ll.q.H, 140, 1)); }
/*    */     
/* 71 */     }  this.q = this.t;
/* 72 */     this.r = this.u;
/* 73 */     this.s = this.v;
...
/* Location:              /home/luigi/Documents/JAR.jar!/SCPCraft/particles/SCPSmokeFX2.class
