...
/*    */ 
/*    */ 
/*    */ public class SCPItem310
/*    */   extends SCPItemDocument
/*    */ {
/*    */   public SCPItem310(int i) {
/* 17 */     super(i);
/* 18 */     this.ck = 1;
/* 19 */     e(1);
/*    */   }
...
/* 24 */     list.add("§eSCP-310");
/* 25 */     list.add("§7The Eternal Flame");
/*    */   }
/*    */ 
/*    */   
/*    */   public boolean n_() {
...
/*    */         {
/* 62 */           par3World.d(par4 + length, par5 + height, par6 + width, amq.w.cm, 0); } 
/*    */       } 
...
/*    */       } 
/* 70 */     }  par3World.d(par4 + 3, par5 + 1, par6 + 3, mod_SCP.SCP310.cm, 0);
/* 71 */     par3World.d(par4 + 3, par5, par6 + 3, amq.w.cm, 0);
...
/* 75 */     par3World.d(par4 + 2, par5 + 1, par6 - 3, mod_SCP.KeycardSlotLv2.cm, 2);
/* 76 */     par3World.d(par4 + 3, par5 + 1, par6 - 1, mod_SCP.KeycardSlotLv2.cm, 1);
/*    */     
/* 78 */     int i = par3World.a(par4, par5, par6);
/* 79 */     par1ItemStack.a--;
/* 80 */     par2EntityPlayer.b("SCP-310 Spawned. | [Type: §eEuclid§f]");
/*    */     
/* 82 */     return true;
/*    */   }
/*    */ 
...
/* Location:              /home/luigi/Documents/JAR.jar!/SCPCraft/items/SCPItem310.class
