...
/*    */ import yc;
/*    */ 
/*    */ public class SCPBlockKeycardSlotLv2
/*    */   extends SCPBlockKeycardSlot
/*    */ {
/*    */   public SCPBlockKeycardSlotLv2(int i, int j) {
/* 13 */     super(i, j);
/* 14 */     b(true);
...
/* 25 */       return true;
/*    */     }
/* 27 */     if (itemstack != null && (itemstack.c == mod_SCP.L2Keycard.cj || itemstack.c == mod_SCP.L3Keycard.cj || itemstack.c == mod_SCP.OmniKeycard.cj)) {
/*    */       
/* 29 */       int k = 8 - (i & 0x8);
...
/* 37 */       par1World.d(par2, par3, par4, mod_SCP.KeycardSlotLv3.cm, j);
/* 38 */       itemstack.a(1, (md)par5EntityPlayer);
/* 39 */       if (par1World.I)
/*    */       {
/* 41 */         par5EntityPlayer.b("Keycard Level: 3");
/*    */       }
/*    */       
/* 44 */       if (!par1World.I)
/*    */       {
/* 46 */         par5EntityPlayer.b("Keycard Level: 3");
/*    */       }
/*    */     }
/*    */     else {
/*    */       
/* 51 */       if (par1World.I)
/*    */       {
/* 53 */         par5EntityPlayer.b("You need a Level 2 or higher Keycard to activate.");
/*    */       }
/* 55 */       if (!par1World.I)
/*    */       {
/* 57 */         par5EntityPlayer.b("You need a Level 2 or higher Keycard to activate.");
/*    */       }
/*    */     } 
/*    */     
...
/* Location:              /home/luigi/Documents/JAR.jar!/SCPCraft/blocks/SCPBlockKeycardSlotLv2.class
